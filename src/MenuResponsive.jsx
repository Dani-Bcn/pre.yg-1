...
stateMenuResp?
  ...
  return (
    <main id="mainMenu" onClick={()=> setStateMenuResp(false)} className="z-[10] ml-[-100vw] fixed  w-full h-full flex items-center justify-start bg-red-700/[0.8] backdrop-blur-md">
