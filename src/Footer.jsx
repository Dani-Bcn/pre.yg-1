      ...
      <section className="w-[80vw] h-40 p-5 flex justify-center flex-col items-center">
        ...
        <article className="flex w-[80vw] pt-5 justify-between items-center">
          ...
          <a
            ...
            target="_blank"
          >
            <img src="social/insta.png" alt="" className="w-6 h-5" />
          </a>
          <a
          ...
          >
            {" "}
            <img src="social/youtube.png" alt="" className="w-6 h-5" />
          </a>
          <a
          ...
          >
            {" "}
            <img src="social/linkedin.png" alt="" className="w-6 h-5" />
          </a>
          <a href="https://twitter.com/YG1worldwide" target="_blank">
            <img src="social/twiter.png" alt="" className="w-6 h-5" />
          </a>
        </article>
